...
SAUCECTL_VERSION=0.4.1

build_base_flavor:
	docker build -f Dockerfile.base \
		--build-arg PLAYWRIGHT_VERSION=${PLAYWRIGHT_VERSION} \
		-t ${DOCKER_REGISTRY}saucelabs/sauce-playwright:${PLAYWRIGHT_VERSION} .\
		${NO_CACHE}
...
push_base_flavor:
	docker push ${DOCKER_REGISTRY}saucelabs/sauce-playwright:${PLAYWRIGHT_VERSION}
